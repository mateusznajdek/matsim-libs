...
public class FISS implements DepartureHandler, MobsimEngine {
	...
	private boolean switchOffFISS() {
		return (this.fissConfigGroup.switchOffFISSLastIteration && this.matsimServices.getConfig().controler().getLastIteration() == this.matsimServices.getIterationNumber());
	}
